        ...
        CelesteDestination.Content -> when {
            activeSummary != null -> {
                ...
                ConversationScreen(
                    ...
                    busyInputPolicy = ui.busyInputPolicy,
                    redirectSupported = ui.redirectSupported,
                    deliveryStatus = ui.deliveryStatus,
                    ...
                    onRedirect = viewModel::redirectMessage,
                    onSelectBusyInputPolicy = viewModel::selectBusyInputPolicy,
